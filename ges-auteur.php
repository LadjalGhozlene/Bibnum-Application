...
<form method="POST" action="#">
 <div class="row">
   ...
   <div class="col-lg-6" align="center">
	   ...
	   <a href="addauteur.php"><button class="btn btn-success" type="button">Ajouter un Auteur</button></a>
	   </div>
	   
  </div>
 </div><hr>
		<div class="panel alert-info"><h2 align="center">Gestion des Auteurs</h2></div>
  <div class="row">
