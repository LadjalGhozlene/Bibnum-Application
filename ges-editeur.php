...
//rechercher dans toutes les colonnes
    $q = "SELECT * FROM editeur 
    WHERE id_editeur = '.$valueToSearch.' OR intitule LIKE '%".$valueToSearch."%'";
...
<form method="POST" action="#">
 <div class="row">
   ...
   <div class="col-lg-6" align="center">
	   ...
	   <a href="addedition.php"><button class="btn btn-success" type="button">Ajouter une Edition</button></a>
	   </div>
	   
  </div>
 </div><hr>
		<div class="panel alert-info"><h2 align="center">Gestion des Edition</h2></div>
  <div class="row">
...
?>
<tr>
    <td><?php echo $row['id_editeur'];?></td>
    <td><?php echo $row['intitule'];?></td>
    <td><?php echo $row['nom'];?></td>
    <td><img src="../editeur/<?php echo $row['logo'];?>.JPG" width="40"alt=""/></td>
</tr>
